...
| EU-permit phrases as positive signals, never filters | `scripts/job_sources.py` (PREFERRED_SIGNAL_WEIGHTS), `CLAUDE.md` "Candidate EU status" | keep | Estonian OU context; a requirement, not a heuristic. |
