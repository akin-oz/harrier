...
record a status change at all. Three remain unwritten: the vacancy liveness
check (newly added to the parity matrix, which had missed it entirely), bulk
contact search over applied rows, and the GUI surfaces beyond the tracker
table. Everything else is approved and
