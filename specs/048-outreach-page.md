...
- [ ] an unknown job selector reaches the operator rather than rendering
      nothing
- [ ] every outreach route requires the token, reads included: these responses
      name a person who is not the operator
